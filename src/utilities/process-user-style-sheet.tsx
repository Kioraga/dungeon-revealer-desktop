 ...
 *
 * Prefixes all rules to be scoped to the provided scope selector in order to avoid user-styles to affect any other styles within dungeon-revealer-desktop.
 */
